...
public class ManHinhChinh extends JFrame implements ActionListener{
	...
	public ManHinhChinh() {
		...
		mntmPCCT = new JMenuItem("Phân công ca trực");
		mnXuLy.add(mntmPCCT);
		
		mntmDatPhong = new JMenuItem("Đặt phong");
		mnXuLy.add(mntmDatPhong);
		
		mntmChamCong = new JMenuItem("Chấm công");
		mnXuLy.add(mntmChamCong);
		
		JMenu mnThongKe = new JMenu("Thống kê");
		menuBar.add(mnThongKe);
		
		mntmTKTNgay = new JMenuItem("Thống kê theo ngày");
		mnThongKe.add(mntmTKTNgay);
		
		JMenuItem mntmNewMenuItem_1_2_2 = new JMenuItem("Thống kê theo quý");
		mnThongKe.add(mntmNewMenuItem_1_2_2);
		
		JMenuItem mntmNewMenuItem_2_2_2 = new JMenuItem("Thống kê theo năm");
